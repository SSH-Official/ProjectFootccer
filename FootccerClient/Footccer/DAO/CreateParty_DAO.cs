...
namespace FootccerClient.Footccer.DAO
{
    public partial class CreateParty_DAO : DAO_Base
    {
        ...
        public int setPartyDTO(PartyInfoDTO dto) => ExecuteTransaction(new CRUD(), (CRUD) => CRUD.insertParty(dto));
        ...
        public int setFormationDTO(FormationDTO formationDTO) => ExecuteTransaction(new CRUD(), (CRUD) => CRUD.insertFormation(formationDTO));
    }
